-- Marketing Sloganizer Database Schema (Fixed)
...
DROP TABLE IF EXISTS slogans CASCADE;
...
CREATE INDEX slogans_user_id_idx ON slogans(user_id);
CREATE INDEX slogans_created_at_idx ON slogans(created_at DESC);
CREATE INDEX favorites_user_id_idx ON favorites(user_id);
CREATE INDEX favorites_slogan_id_idx ON favorites(slogan_id);
...
-- Insert default plans (after table is created)
INSERT INTO subscription_plans (name, monthly_limit, price_cents, features) VALUES
